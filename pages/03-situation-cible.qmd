...
::: {.callout-note}
Biensûr, notre situation cible concerne uniquement le package, notre objectif final est encore plus grand. Comme vous pouvez le voir ci-dessous, le package constitue un maillon d'une chaine bien plus grande qui arrivera dans les chapitres suivants.

::: {style="text-align: center;"}
![](../images/image-01-bis.png){width=70%}
:::
