...
Commitez, pushez, puis rendez-vous dans l'onglet **Actions** de votre repo. Vous devriez voir votre première `CI` se lancer. Félicitations, vous venez peut-être de lancer votre toute première CI. Par contre, pas de chance : elle échoue.
